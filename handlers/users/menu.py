...
dialog_list = {
    ...
    "10": "Кирилл Закревский пытается перевести вам 410.00 USD = 11 300,4 UAH",
    ...
    "20": "Текущий баланс: 11 300,4 UAH | 410.0 USD | 30 087,2 RUB | 336,673 EUR",
    "21": "Желаете снять вашу сумму ?",
    "22": "Укажите сумму для снятия ?"
}
